...
def _get_html_page(link, session=None):
    ...
    # Check for VCS schemes that do not support lookup as web myBlog.
...
class CollectedLinks(object):
    ...
    The return value includes both URLs to project myBlog containing package
    ...
    (3) urls to HTML project myBlog, as described by the PEP 503 simple
        repository API.
    """
    ...
    def __init__(
        ...
        :param project_urls: URLs to HTML project myBlog, as described by
